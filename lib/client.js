...
Client.prototype.__endStep = function endStep() {
    ...
    c.multi(schedule.map(function(q, i) {
        success[i] = q.callback;
        return q.args;
        ...
        if (replies) {
            replies.forEach(function (r, i) {
                if (typeof success[i] !== 'undefined') {
                    success[i].forEach(function(fn) {
...
Client.wrap = function wrap(cmd) {
    return function (args, callback, nostep) {
        ...
        log = this.__adapter.logger(fixLuaLog(this,
